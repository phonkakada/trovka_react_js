...
const Car = ({ Image, Price, Model, Make, Location, Ram, CPU,  Like, UnLike, setUserLike, userLike, setUserUnLike, userUnLike, Year }) => {
    return (
        <>
