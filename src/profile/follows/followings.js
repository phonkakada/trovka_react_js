...
const DisplayAllFollowings = ({ UUID, Token }) => {
    let arr = []
    ...
    return (
        <>
            <p className="text-blue-500 sticky top-6 text-3xl font-bold ml-7 mt-5">Followings</p>
            <div>
                {arr}
            </div>
        </>
                    ...
                    <div className="flex items-center w-full justify-evenly">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="text-start ml-5">
                                <p className="text-sm md:text-xl">{toName}</p>
                                <p className="text-xs md:text-sm font-light">{date}</p>
                            </div>
                        </div>

                        <div className="bg-blue-400 p-2 rounded-md text-white hover:shadow-lg md:p-4"><button>Unfollwing</button></div>
                    </div>
...
export default DisplayAllFollowings